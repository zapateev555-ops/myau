...
<section class="page-header-gradient page-header--delivery">
    <div class="mp-container position-relative">
        ...
        <p class="lead mb-0">От 5 000 ₽ по городу и в регионы России</p>
    </div>
</section>
...
<section class="py-5">
    <div class="mp-container">
        <div class="row g-5 align-items-start">
            <div class="col-lg-7">
                <p class="lead fw-medium ac-content-title">Доставим автозапчасти быстро и аккуратно — до пункта выдачи или по адресу.</p>
                <p class="text-muted">Заказы от 5 000 ₽ доставляем бесплатно по Чебоксарам. В другие города отправляем транспортными компаниями: СДЭК, Boxberry, ПЭК. Срок и стоимость рассчитываем при оформлении заказа.</p>
                ...
                <div class="row g-3 align-items-stretch">
                    <div class="col-md-4">
                        <div class="value-card h-100">
                            ...
                            <p class="text-muted small mb-0">Бесплатно от 5 000 ₽. При меньшей сумме — 390 ₽. Срок 1–2 рабочих дня.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="value-card h-100">
                ...
                <ol class="text-muted">
                    ...
                    <li>Получаете запчасти и при необходимости записываетесь на СТО.</li>
                </ol>
            </div>
            <div class="col-lg-5">
